...
public class MaximizeAmountAfterTwoDaysofConversions {
    public static void main(String[] args) {
        System.out.println(maxAmount("EUR",List.of(List.of("EUR","USD"),List.of("USD","JPY")),new double[]{2.0,3.0},
    ...
    private static Map<String, Double> getMaxAmounts(String startCurrency, Map<String, Map<String, Double>> graph)
    {
    ...
    private static Map<String, Double> getMaxAmounts(String startCurrency, Map<String, Map<String, Double>> graph, Map<String, Double> initialAmounts)
    {
