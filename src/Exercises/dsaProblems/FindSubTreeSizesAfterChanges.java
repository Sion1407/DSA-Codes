...
public class FindSubTreeSizesAfterChanges {
    public static void main(String[] args) {
        int[] res = findSubtreeSizes(new int[]{-1, 0, 0, 1, 1, 1}, "abaabc");
    ...
    public static void dfsAdjustParent(int node, String s, List<List<Integer>> adj, Map<Character, Integer> lastSeen, int[] newParent) {
    ...
    public static int dfsCountSubtreeSizes(int node, List<List<Integer>> adj, int[] answer) {
        int size = 1;
        for (int child : adj.get(node)) {
